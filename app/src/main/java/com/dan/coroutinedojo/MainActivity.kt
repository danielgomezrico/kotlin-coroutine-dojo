...
private val levels = listOf(
    ...
    Level("Level 3", "Structured Concurrency", Level3Activity::class.java),
    Level("Level 4", "StateFlow & SharedFlow", Level4Activity::class.java),
    Level("Level 5", "Channels & Backpressure", Level5Activity::class.java),
)
